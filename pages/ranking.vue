        ...
        <v-col class="text-center" lg="9">
          <template v-if="scores.length > 0">
            <template v-if="scores.length > 2">
              <v-card>
                <v-row justify="center" class="d-flex align-end mb-6">
                  <v-col align="center" class="ma-2">
                    ...
                    >
                      <v-row align="center" justify="center">
                        <div class="text-h2 font-weight-bold">2</div>
                      </v-row>
                    </v-container>
                  </v-col>
                  <v-col align="center" class="ma-2">
                    ...
                    >
                      <v-row align="center" justify="center">
                        <div class="text-h2 font-weight-bold">1</div>
                      </v-row>
                    </v-container>
                  </v-col>
                  <v-col align="center" class="ma-2">
                    ...
                    >
                      <v-row align="center" justify="center">
                        <div class="text-h2 font-weight-bold">3</div>
                      </v-row>
                    </v-container>
                  </v-col>
                </v-row>
