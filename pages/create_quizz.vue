<template>
  <div>
            ...
            <v-container>
              <v-form v-model="quizzValid">
                ...
                <v-radio-group v-model="Difficulty" row>
                  <v-radio label="Easy" color="success" value="Easy"></v-radio>
                  <v-radio label="Normal" color="secondary" value="Normal"></v-radio>
                  <v-radio label="Hard" color="error" value="Hard"></v-radio>
                </v-radio-group>
                <v-select
                  v-model="ChoosenMap"
                  :items="mapItems"
            ...
            <v-row>
              ...
              <v-col cols="5" sm="6" md="4">
                <v-container fluid>
                  ...
                  <v-row class="mb-6">
                    <v-virtual-scroll :items="questions" height="270" item-height="64">
    ...
    <v-dialog v-model="successDialog" persistent max-width="320">
      <v-card>
        <v-card-title class="headline"> Creation of your quizz </v-card-title>
        ...
        <v-card-actions>
          ...
          <v-btn href="/create_quizz" color="green darken-1" text @click="successDialog = false"> Create new quizz </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <v-dialog v-model="errorDialog" persistent max-width="320">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="green darken-1" text @click="errorDialog = false"> Modify </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
  ...
  methods: {
    ...
    submitQuestion() {
      if (this.questions.length >= this.questionsNumber)
        alert("Please modify the number of questions if you want to add questions");
      else {
